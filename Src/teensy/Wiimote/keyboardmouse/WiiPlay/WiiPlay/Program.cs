...
namespace WiiPlay
{
    class Program
    {
        ...
        public unsafe static extern void MoveMouseBy(int x, int y);
        [DllImport("user32.dll")]
        public unsafe static extern void SetPhysicalCursorPos(int X, int Y);
        [DllImport("user32.dll")]
        public unsafe static extern void SetCaretPos(int X, int Y);
        [DllImport("user32.dll")]
        public unsafe static extern void SetCursorPos(int X, int Y);
        ...
        public static void taskI()
        {
            for (; ; )
            {
                ...
                if (iry <= -768f)
                    iry = -768f;
                mousex = (irx >= 0f ? 1f : -1f) * (Math.Pow(irx >= 0 ? irx : -irx, 4f) / Math.Pow(1360f, 3f) * (1f - 1360f / (127f * 440f)) + Math.Pow(irx >= 0 ? irx : -irx, 0.5f) * Math.Pow(1360f, 0.5f) * 1360f / (127f * 440f));
                mousey = (iry >= 0f ? 1f : -1f) * (Math.Pow(iry >= 0 ? iry : -iry, 4f) / Math.Pow(768f, 3f) * (1f - 768f / (127f * 240f)) + Math.Pow(iry >= 0 ? iry : -iry, 0.5f) * Math.Pow(768f, 0.5f) * 768f / (127f * 240f));
                Thread.Sleep(1);
            }
        }
        public unsafe static void taskM()
        {
            for (; ; )
            {
                if (Getstate)
                {
                    MoveMouseBy((int)(-mousex * 400f / 1360f), (int)(mousey * 300f / 768f));
                    System.Windows.Forms.Cursor.Position = new System.Drawing.Point((int)(WidthS - mousex * WidthS / 1360f), (int)(HeightS + mousey * HeightS / 768f));
                    SetPhysicalCursorPos((int)(WidthS - mousex * WidthS / 1360f), (int)(HeightS + mousey * HeightS / 768f));
                    SetCaretPos((int)(WidthS - mousex * WidthS / 1360f), (int)(HeightS + mousey * HeightS / 768f));
                    SetCursorPos((int)(WidthS - mousex * WidthS / 1360f), (int)(HeightS + mousey * HeightS / 768f));
        ...
        public unsafe static void taskK()
        {
            for (; ; )
            {
                ...
                if (Getstate)
                {
                    ...
                    if (wd[3] == 1)
                        teensy.KeyboardPress(Keylayout.KEY_P);
                    if (wu[3] == 1)
                    {
                        teensy.KeyboardRelease(Keylayout.KEY_P);
                        clickpressing = true;
                    }
                    ...
                    if (wd[13] == 1)
                        teensy.KeyboardPress(Keylayout.KEY_R);
                    if (wu[13] == 1)
                        teensy.KeyboardRelease(Keylayout.KEY_R);
                    valchanged(22, mWSButtonStateHome);
                    if (wd[22] == 1)
                        teensy.KeyboardPress(Keylayout.KEY_F);
                    if (wu[22] == 1)
                        teensy.KeyboardRelease(Keylayout.KEY_F);
                    valchanged(23, mWSButtonStateMinus);
                    if (wd[23] == 1)
                    {
                        if (keys54321 == 0)
                    ...
                    valchanged(24, mWSButtonStatePlus);
                    if (wd[24] == 1)
                    {
                        if (keys12345 == 0)
                            teensy.KeyboardPress(Keylayout.KEY_1);
                    ...
                    valchanged(15, mWSButtonStateLeft);
                    if (wd[15] == 1)
                        teensy.KeyboardPress(Keylayout.KEY_Y);
                    if (wu[15] == 1)
                    {
                        teensy.KeyboardRelease(Keylayout.KEY_Y);
                        clickpressing = true;
                    }
                    valchanged(14, mWSButtonStateRight);
                    if (wd[14] == 1)
                        teensy.KeyboardPress(Keylayout.KEY_U);
                    if (wu[14] == 1)
                    {
                        teensy.KeyboardRelease(Keylayout.KEY_U);
                        clickpressing = true;
                    }
                    ...
                    if (wu[26] == 1)
                        teensy.KeyboardRelease(Keylayout.KEY_ESC);
                    valchanged(11, mWSButtonStateB | clickreleasing >= 10);
                    if (wd[11] == 1)
                    {
                        if (ws[33])
                    ...
                    foraorcison = mWSButtonStateMinus | mWSButtonStatePlus | mWSButtonStateHome | mWSButtonStateOne | mWSButtonStateTwo | mWSNunchuckStateZ | ((mWSRawValuesZ > 0 ? mWSRawValuesZ : -mWSRawValuesZ) >= 40f & (mWSRawValuesY > 0 ? mWSRawValuesY : -mWSRawValuesY) >= 40f & (mWSRawValuesX > 0 ? mWSRawValuesX : -mWSRawValuesX) >= 40f) | ((mWSNunchuckStateRawValuesY > 33f) & !(rolling <= -48f) & !(rolling >= 48f) & !((mWSRawValuesZ > 0 ? mWSRawValuesZ : -mWSRawValuesZ) >= 40f & (mWSRawValuesY > 0 ? mWSRawValuesY : -mWSRawValuesY) >= 40f & (mWSRawValuesX > 0 ? mWSRawValuesX : -mWSRawValuesX) >= 40f));
                    if (wd[27] == 1)
                        if (!randA)
                        {
